                            ...
                            {currentData.map((item, index) => (
                                <tr key={index} style={{ borderBottom: "1px solid #f0f0f0" }}>
                                    <td className="ps-4 py-3 fw-bold text-dark d-flex align-items-center">
                                        <div className="me-2 d-flex align-items-center justify-content-center" style={{ width: '24px', height: '24px' }}>
                                            {item.iconClass ? (
                                                <i className={`${item.iconClass}`} style={{ fontSize: "20px", color: item.color || "#0f4941" }}></i>
                                            ) : (
                                                item.icon && (
                                                    <Image
                                                        src={item.icon}
